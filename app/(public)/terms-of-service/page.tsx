...
export default function TermsOfServicePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="font-mono text-2xl text-text mb-6">Terms of Service</h1>
      <div className="space-y-4 text-sm text-muted leading-relaxed">
        <p>Terakhir diperbarui: {new Date().toLocaleDateString("id-ID")}</p>

        <h2 className="font-mono text-lg text-text pt-4">Penggunaan layanan</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Script premium &amp; pembayaran</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Konten developer</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Pembatasan tanggung jawab</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Perubahan ketentuan</h2>
        <p>
