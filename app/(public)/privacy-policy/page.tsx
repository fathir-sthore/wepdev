...
export default function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 prose-invert">
      <h1 className="font-mono text-2xl text-text mb-6">Privacy Policy</h1>
      <div className="space-y-4 text-sm text-muted leading-relaxed">
        <p>Terakhir diperbarui: {new Date().toLocaleDateString("id-ID")}</p>

        <h2 className="font-mono text-lg text-text pt-4">Data yang kami kumpulkan</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Bagaimana kami menggunakan data</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Penyimpanan &amp; keamanan</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Hak kamu</h2>
        <p>
        ...
        <h2 className="font-mono text-lg text-text pt-4">Kontak</h2>
        <p>
