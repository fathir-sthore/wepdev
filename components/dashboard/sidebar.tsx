...
import { LayoutDashboard, Search, Heart, Download, LogOut, Code2, ShieldCheck, Receipt, User, FileCode, Server } from "lucide-react";
...
const links = [
  ...
  { href: "/dashboard/vps", label: "vps saya", icon: Server, exact: false },
