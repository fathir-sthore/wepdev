...
import { Menu, LayoutDashboard, ArrowLeftCircle, Code2, Search, Settings, Download, Server, X } from "lucide-react";
...
export function HamburgerMenu() {
  ...
  const links = [
    ...
    { href: "/panel-hosting", label: "panel & hosting", icon: Server },
