...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 border-r border-line bg-panel min-h-screen p-4 flex flex-col">
      ...
      <ChangelogModal
        trigger={
          <span className="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-mono text-muted hover:text-text hover:bg-panel2 transition-colors">
            <Sparkles size={16} />
            changelog v1.0.2
          </span>
        }
